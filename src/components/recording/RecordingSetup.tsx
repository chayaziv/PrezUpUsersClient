...
const suggestedTags = [
  'Education', 'Business', 'Technology', 'Marketing', 
  'Design', 'Development', 'Science', 'Art', 'Health',
  'Finance', 'Personal', 'Tutorial'
];

const RecordingSetup: React.FC<RecordingSetupProps> = ({ initialData, onComplete }) => {
