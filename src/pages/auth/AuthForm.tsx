...
// import { containerStyles, paperStyles, avatarStyles, formStyles, submitButtonStyles, dividerStyles, socialButtonStyles, googleButtonHover, githubButtonHover } from "../../styles/authFormStyle";
// import BaseTextField from "@/components/common/BaseTextField";

// // קומפוננטת שדות הטופס
// const AuthFields = ({
//   isSignIn,
//   name,
//   email,
      ...
      <Container component="main" maxWidth="xs" sx={containerStyles}>
        <Paper elevation={3} sx={paperStyles}>
          ...
          <Box component="form" onSubmit={handleSubmit} sx={formStyles}>
            ...
            <ButtonSubmit loading={loading} submitLabel={submitLabel} submitIcon={submitIcon} />
